...
@TeleOp(name = "DecodeTeleopF")
public class DecodeTeleopF extends LinearOpMode{
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            //Flipper code
            if (flip) {flipper.setPower(1);}

            //Reverse
            if (reverse) {
                intake_one.setDirection(CRServo.Direction.REVERSE);
                intake_two.setDirection(CRServo.Direction.REVERSE);
                intake_three.setDirection(DcMotorSimple.Direction.REVERSE);
            } else if (unreverse) {
                intake_one.setDirection(CRServo.Direction.FORWARD);
                intake_two.setDirection(CRServo.Direction.FORWARD);
                intake_three.setDirection(DcMotorSimple.Direction.FORWARD);
            }
