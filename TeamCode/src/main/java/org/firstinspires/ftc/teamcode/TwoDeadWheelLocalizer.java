...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -173.56623197946297; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3635.686209443731; // x position of the perpendicular encoder (in tick units)
    }
